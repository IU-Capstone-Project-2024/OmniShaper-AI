    ...
    def train_step(
        ...
        if target_img is None:
            with torch.no_grad():
                ...
                t_stop = t[0]
                ratio=torch.tensor((step/1000)*iter_steps*0.6,dtype=torch.long)
                ...
                for tt in scheduler.timesteps:
                    ...
                    latents_noisy=scheduler.step(noise_pred,tt,latents_noisy,eta=0.0).prev_sample.to(latents.dtype).clone().detach()
