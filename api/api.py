...
from ml_pipeline.final_model import promt_to_3D
...
def download_obj(file_id: UUID | str) -> StreamingResponse:
    ...
    return StreamingResponse(_get_data_from_file(filepath), media_type="model/obj")
...
def download_mtl(file_id: UUID| str) -> FileResponse:
    ...
    return FileResponse(path=filepath, media_type="model/mtl")
